...
// массива со всеми элементами двух исходных firstArray и secondArray.Параметр maxLength 
...
const array = newArray.length>maxLength ? newArray.slice(0,maxLength) : newArray;
